package top.zhacker.gateway.passport.security;

import top.zhacker.gateway.passport.authentication.mobile.SmsCodeAuthenticationSecurityConfig;
import top.zhacker.gateway.passport.authorize.AuthorizeConfigProvider;
import top.zhacker.gateway.passport.config.ClassPathTldsLoader;
...
import top.zhacker.gateway.passport.validate.code.ValidateCodeSecurityConfig;
import top.zhacker.gateway.passport.authentication.mobile.SmsCodeAuthenticationSecurityConfig;
import top.zhacker.gateway.passport.authorize.AuthorizeConfigProvider;
import top.zhacker.gateway.passport.validate.code.ValidateCodeSecurityConfig;
...
//        http.addFilterBefore(validateCodeFilter, UsernamePasswordAuthenticationFilter.class)
        http.headers().frameOptions().disable().and()
                ...
                .and()
                .apply(validateCodeSecurityConfig)//验证码拦截 addFilterBefore(validateCodeFilter, AbstractPreAuthenticatedProcessingFilter.class);
                .and()
                .apply(smsCodeAuthenticationSecurityConfig) //addFilterAfter(smsCodeAuthenticationFilter, UsernamePasswordAuthenticationFilter.class)
                .and()
                .apply(merryyouSpringSocialConfigurer)//社交登录 addFilterBefore((Filter)this.postProcess(filter), AbstractPreAuthenticatedProcessingFilter.class)
                .and()
                .rememberMe()
